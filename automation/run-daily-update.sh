...
report_with_header="$STATE_DIR/reports/.${TODAY}.$$.md"
{
  ...
  print -r -- ""
  print -r -- "This report was generated by the deterministic local triage runner used alongside Codex CLI. The website repository was not edited, committed, or pushed."
  print -r -- ""
  /bin/cat "$report_tmp"
} > "$report_with_header"
